...
# UTILS
# Func booleana para determinar si un elemento tiene variable
...
# Func booleana para determinar si un elemento con variable tiene potencia
...
# Func para sacar la potencia de un elemento que tenga variable
